...
/// _XMLReferencingEncoder is a special subclass of _XMLEncoder which has its own
...
/// superclass -- the lifetime of the encoder should not escape the scope it's created in, but it
