...
internal struct _XMLUnkeyedDecodingContainer: UnkeyedDecodingContainer {
    ...
    public mutating func decode(_ type: Bool.Type) throws -> Bool {
        ...
        guard
            let decoded = try self.decoder.unbox(
                self.container[self.currentIndex],
                as: Bool.self
            )
        else {
            throw DecodingError.valueNotFound(
    ...
    public mutating func decode(_ type: Int8.Type) throws -> Int8 {
        ...
        guard
            let decoded = try self.decoder.unbox(
                self.container[self.currentIndex], as: Int8.self
            )
        else {
            throw DecodingError.valueNotFound(
                type,
    ...
    public mutating func decode(_ type: Int16.Type) throws -> Int16 {
        ...
        guard let decoded = try self.decoder.unbox(
            self.container[self.currentIndex], as: Int16.self
        )
        else {
            throw DecodingError.valueNotFound(
                type,
    ...
    public mutating func decode(_ type: Int32.Type) throws -> Int32 {
        ...
        guard let decoded = try self.decoder.unbox(
            self.container[self.currentIndex], as: Int32.self
        )
        else {
            throw DecodingError.valueNotFound(
                type,
    ...
    public mutating func decode(_ type: Int64.Type) throws -> Int64 {
        ...
        guard let decoded = try self.decoder.unbox(
            self.container[self.currentIndex], as: Int64.self
        )
        else {
            throw DecodingError.valueNotFound(
                type,
