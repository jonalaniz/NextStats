...
class AddServerViewController: UIViewController, UITextFieldDelegate {
    ...
    func setupUI() {
        ...
        nicknameField.attributedPlaceholder = NSAttributedString(string: "MyServer", attributes: [NSAttributedString.Key.foregroundColor: UIColor.label])
        
        styleTextField(textField: serverURLField)
        serverURLField.attributedPlaceholder = NSAttributedString(string: "https://cloud.example.com", attributes: [NSAttributedString.Key.foregroundColor: UIColor.label])
